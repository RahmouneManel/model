...
parser.add_argument('--image_dir', type = str, default = 'Monument/test/5554/00bba0b349dae153.jpg', help = 'Path to image')
...
parser.add_argument('--json', type = str, default = 'Landmarks_to_name.json', help = 'class_to_name json file')
